...
export const coursesData: CourseOption[] = [
  ...
  { name: "Structured Programming", code: "CSE221", creditHours: 3 },
  { name: "Structured Programming Lab", code: "CSE222", creditHours: 1.5 },
  { name: "Basic Electrical Engineering", code: "CSE123", creditHours: 3 },
  { name: "Basic Electrical Engineering Lab", code: "CSE224", creditHours: 1.5 },
  { name: "Physics ii", code: "PHY123", creditHours: 3 },
  { name: "Differential Equation & Laplace Transform", code: "MAT123", creditHours: 3 },
  { name: "English II", code: "ENG115", creditHours: 3 },
  { name: "Engineering Ethics and Cyber Law", code: "GED119", creditHours: 2 },
  { name: "Discrete Mathematics", code: "CSE125", creditHours: 3 },
  { name: "Bangladesh Studies", code: "GED201", creditHours: 3 },
  { name: "History of Emergence of Bangladesh", code: "GED202", creditHours: 3 },
  { name: " English I", code: "SOC101", creditHours: 3 },
  { name: "Physics I", code: "BUS101", creditHours: 3 },
